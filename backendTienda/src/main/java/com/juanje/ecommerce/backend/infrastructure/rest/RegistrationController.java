...
import com.juanje.ecommerce.backend.application.RegistrationService;
...
@Slf4j
public class RegistrationController { //creo mi endpoint para registrar un usuario
    ...
    @PostMapping("/register") //levanto un endpoint para poder registrar un usuario
